...
const Transfer = ({ selectedToken, setAction, thirdWebTokens, walletAddress }) => {
    ...
    useEffect(() => {
        const activeToken = thirdWebTokens.find(token => token.address === selectedToken.contractAddress) //match this sanity token with thirdweb token
        // console.log(activeToken, 'hurrah')
    ...
    // to retrieve balance of that token
    useEffect(() => {
